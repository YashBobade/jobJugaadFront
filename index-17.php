...
<!-- Mirrored from thewebmax.org/jobzilla/index-17.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:22:51 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Jobzilla Template | Home Page Style 17</title>
...
<body>
	...
	<div class="page-wraper">
        ...
        <!-- HEADER START -->
        <header  class="site-header header-style-3 h-page-14-hdr">
                    ...
                    <div class="container-fluid"> 
                        ...
                        <div class="logo-header">
                            <div class="logo-header-inner logo-header-one">
                                <a href="index.html">
                                <img src="images/skins-logo/logo-skin-9.png" alt="">
                                </a>
                            </div>
                        </div>  
                        ...
                        <div class="extra-nav header-2-nav">
                            ...
                            <div class="extra-cell">
                                <a href="javascript:;" class="vnav-btn dark" id="twm-side-navigation">
            ...
            <!-- MAIN Vav -->
            <div class="twm-side-navigation-menu">
                <div class="nav-sidebar-wrap  scrollbar-macosx">
        ...
        <div class="page-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 twm-bnr-left-section">
                            <div class="twm-bnr-left-content">
                                <div class="bnr-media">
                                    <img src="images/home-17/banner/pic.png" alt="#">
                                </div>
            ...
            <div class="section-full p-t120 p-b90 site-bg-white twm-featured-city-carousal-area">
                <div class="container">
                    ...
                    <div class="wt-separator-two-part ">
                        <div class="row wt-separator-two-part-row">
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-12 wt-separator-two-part-right text-right">
                                <a href="job-list.html" class=" site-button">View All Locations</a>
                            </div>
                        </div>
                    </div>                
                    <!-- TITLE END-->
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="widget widget_about">
                                <div class="logo-footer clearfix">
                                    <a href="index.html"><img src="images/skins-logo/logo-skin-9-ftr.png" alt=""></a>
                                </div>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="index-17a39b.html?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="index-1761e7.html?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="index-17cce5.html?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="index-1713f7.html?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="index-1719a6.html?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="index-17fe5c.html?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="index-17ab47.html?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="index-175f8d.html?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="index-175663.html?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="index-1728ac.html?theme=css/skin/skin-10"></a></li>
        </ul>           
...
<!-- Mirrored from thewebmax.org/jobzilla/index-17.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:22:54 GMT -->
</html>
