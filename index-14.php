...
<!-- Mirrored from thewebmax.org/jobzilla/index-14.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:22:41 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Jobzilla Template | Home Page Style 14</title>
...
<body data-anm=".anm">
	...
	<div class="page-wraper">
                ...
                <div class="main-bar">  
                    ...
                    <div class="container-fluid"> 
                        ...
                        <div class="extra-nav header-2-nav">
                            ...
                            <div class="extra-cell">
                                <a href="javascript:;" class="vnav-btn" id="twm-side-navigation">
        ...
        <div class="page-content">
            <!--Banner Start-->
            <div class="twm-home3-banner-section twm-bnr-hpage-14" style="background-image: url(images/home-14/banner-bg/dotted-patern.png);">
                <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12 twm-hpage-14-bnr-left-content">
                                <div class="twm-bnr-mid-section">
                                    <div class="twm-bnr-title-large">We Are Looking</div>
                                    <div class="twm-bnr-title-light-2">For New <span class="site-text-primary">Job</span></div>
                            ...
                            <div class="col-xl-6 col-lg-5 col-md-12 twm-hpage-14-bnr-right-content">
                                <div class="twm-hpage-14-bnr-right">
                                    <div class="twm-media">
                                        <img src="images/home-14/banner-bg/right-pic.png" alt="Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="widget widget_about">
                                <div class="logo-footer clearfix">
                                    <a href="index.html"><img src="images/logo-14.png" alt=""></a>
                                </div>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="index-14a39b.html?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="index-1461e7.html?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="index-14cce5.html?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="index-1413f7.html?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="index-1419a6.html?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="index-14fe5c.html?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="index-14ab47.html?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="index-145f8d.html?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="index-145663.html?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="index-1428ac.html?theme=css/skin/skin-10"></a></li>
...
<!-- Mirrored from thewebmax.org/jobzilla/index-14.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:22:44 GMT -->
</html>
