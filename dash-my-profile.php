...
<!-- Mirrored from thewebmax.org/jobzilla/dash-my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:25:25 GMT -->
<head>
        ...
        <div id="content">
            ...
            <div class="content-admin-main">
            	...
            	<div class="wt-admin-right-page-header clearfix">
                    <h2>My Profile</h2>
                    <div class="breadcrumbs"><a href="#">Home</a><a href="#">Dasboard</a><span>Profile</span></div>
                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="ls-inputicon-box"> 
                                            <input class="form-control" name="company_since" type="text" placeholder="Job Title">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="form-group city-outer-bx has-feedback">
                                        ...
                                        <div class="ls-inputicon-box">  
                                            <select class="wt-select-box selectpicker" name="Job type" data-live-search="true" title="Job Type" id="city" data-bv-field="size">
                                                <option class="bs-title-option" value="">Full Time</option>
                                                <option class="" value="">Part time</option>
                                                <option class="" value="">Freelance</option>
                                            </select>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="ls-inputicon-box"> 
                                            <input class="form-control" name="company_since" type="text" placeholder="Qualification">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="form-group city-outer-bx has-feedback">
                                        ...
                                        <div class="ls-inputicon-box">  
                                            <select class="wt-select-box selectpicker" name="Job type" data-live-search="true" title="Job Category" id="j-category" data-bv-field="size">
                                                <option class="bs-title-option" value="">IT & Software</option>
                                                <option class="" value="">Accountant</option>
                                                <option class="" value="">Bank Services</option>
                                                <option class="" value="">Hospital</option>
                                            </select>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-12">
                                    <div class="form-group city-outer-bx has-feedback">
                                        ...
                                        <div class="ls-inputicon-box">  
                                            <select class="wt-select-box selectpicker" name="Job type" data-live-search="true" title="Experience" id="Experience" data-bv-field="size">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-12">
                                    <div class="form-group city-outer-bx has-feedback">
                                        ...
                                        <div class="ls-inputicon-box">  
                                            <select class="wt-select-box selectpicker" name="Job type" data-live-search="true" title="Current Salary" id="c_salary" data-bv-field="size">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-12">
                                    <div class="form-group city-outer-bx has-feedback">
                                        ...
                                        <div class="ls-inputicon-box">  
                                            <select class="wt-select-box selectpicker" name="Job type" data-live-search="true" title="Expected Salary" id="e-salary" data-bv-field="size">
                                ...
                                <div class="col-xl-3 col-lg-12 col-md-12">
                                    <div class="form-group city-outer-bx has-feedback">
                                        <label>Age</label>
                                        <div class="ls-inputicon-box">  
                                            <select class="wt-select-box selectpicker" name="Job type" data-live-search="true" title="Expected Salary" id="Age" data-bv-field="size">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3">Greetings! We are Galaxy Software Development Company. We hope you enjoy our services and quality.</textarea>
                                    </div>
                                </div>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="dash-my-profilea39b.html?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="dash-my-profile61e7.html?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="dash-my-profilecce5.html?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="dash-my-profile13f7.html?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="dash-my-profile19a6.html?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="dash-my-profilefe5c.html?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="dash-my-profileab47.html?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="dash-my-profile5f8d.html?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="dash-my-profile5663.html?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="dash-my-profile28ac.html?theme=css/skin/skin-10"></a></li>
...
<!-- Mirrored from thewebmax.org/jobzilla/dash-my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:25:28 GMT -->
</html>
