...
<!-- Mirrored from thewebmax.org/jobzilla/candidate-job-alert.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:24:51 GMT -->
<head>
    <!-- META -->
    <meta charset="utf-8">
    ...
    <!-- PAGE TITLE HERE -->
    <title>Jobzilla Template | Candidate Jobs Alerts</title>
...
<body>
	...
	<div class="page-wraper">
                    ...
                    <div class="wt-bnr-inr-entry">
                        <div class="banner-title-outer">
                            <div class="banner-title-name">
                                <h2 class="wt-title">Candidate Jobs Alert</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            ...
                            <div class="side-bar-st-1">
                                ...
                                <div class="twm-nav-list-1">
                                    <ul>
                                        ...
                                        <li class="active"><a href="candidate-job-alert.html"><i class="fa fa-bell"></i> Job Alerts</a></li>
        ...
        <!--Model Popup Section End-->
         ...
         <!--saved-jobs-view-->
         <div class="modal fade twm-saved-jobs-view" id="saved-jobs-view" aria-hidden="true" aria-labelledby="saved_job_view" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form>

                        <div class="modal-header">
                            <h2 class="modal-title" id="saved_job_view">Company Name</h2>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="candidate-job-alerta39b.html?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="candidate-job-alert61e7.html?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="candidate-job-alertcce5.html?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="candidate-job-alert13f7.html?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="candidate-job-alert19a6.html?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="candidate-job-alertfe5c.html?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="candidate-job-alertab47.html?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="candidate-job-alert5f8d.html?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="candidate-job-alert5663.html?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="candidate-job-alert28ac.html?theme=css/skin/skin-10"></a></li>
...
<!-- Mirrored from thewebmax.org/jobzilla/candidate-job-alert.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:24:54 GMT -->
</html>
