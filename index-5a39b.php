...
<!-- Mirrored from thewebmax.org/jobzilla/index-5.html?theme=css/skin/skin-1 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:25:43 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Jobzilla Template | Home Page Style 5</title>
...
<body data-anm=".anm">
	...
	<div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <!--Banner Start-->
            <div class="twm-home5-banner-section" style="background-image: url(images/home-5/slider/bg-1.jpg);">
                
                <div class="row">
                    <!--Left Section-->
                    <div class="col-xl-6 col-lg-6 col-md-12 btm-bdr-banner">
                        <div class="twm-bnr-left-section">
                            <div class="twm-bnr-title-large">It’s Easy to Find Your <span class="site-text-primary">Dream Job </span></div> 
                            <div class="twm-bnr-discription">You dream job is waiting for you.</div>
                        ...
                        <div class="twm-bnr-right-section anm">
                            <div class="twm-bnr-right-section-inner anm"  data-wow-delay="1000ms" data-speed-x="2" data-speed-y="2">
                                <div class="twm-graphics-h5 twm-p1">
                                    <img src="images/home-5/slider/r-pic1.png" alt="">
                                </div>
                                <div class="twm-graphics-h5 twm-p2">
                                    <img src="images/home-5/slider/r-pic2.png" alt="">
                                </div>

                                <div class="twm-graphics-h5 twm-p3">
                                    <img src="images/home-5/slider/r-pic3.png" alt="">
                                </div>

                                <div class="twm-graphics-h5 twm-p4">
                                    <img src="images/home-5/slider/r-pic4.png" alt="">
                                </div>
                            </div>
                        </div>
            ...
            <div class="section-full p-t120 p-b90 site-bg-white job-categories-home-5-wrap twm-bdr-bottom-1">
                ...
                <div class="section-content twm-jobs-grid-h5-section-outer">
                    <div class="twm-jobs-grid-h5-section overlay-wraper" style="background-image: url(images/home-5/cate-bg.jpg);">
            ...
            <div class="section-full p-t120 p-b90 site-bg-white pos-relative twm-bdr-bottom-1">
                <div class="container">
                    ...
                    <div class="section-head center wt-small-separator-outer">
                        ...
                        <h2 class="wt-title">Connect with the right 
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-st5  m-b30">
                                        ...
                                        <div class="twm-job-st5-top">
                                            <div class="twm-media">
                                                <img src="images/home-5/jobs-company/pic1.jpg" alt="#">
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-st5  m-b30">
                                        ...
                                        <div class="twm-job-st5-top">
                                            <div class="twm-media">
                                                <img src="images/home-5/jobs-company/pic2.jpg" alt="#">
                                            </div>
                                            <div class="twm-com-info">
                                                <p class="twm-job-address">New York, US</p>
                                                <a href="https://themeforest.net/user/thewebmax/portfolio" class="twm-job-com-name site-text-primary">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-st5  m-b30">
                                        ...
                                        <div class="twm-job-st5-top">
                                            <div class="twm-media">
                                                <img src="images/home-5/jobs-company/pic3.jpg" alt="#">
                                            </div>
                                            <div class="twm-com-info">
                                                <p class="twm-job-address">New York, US</p>
                                                <a href="https://themeforest.net/user/thewebmax/portfolio" class="twm-job-com-name site-text-primary">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-st5  m-b30">
                                        ...
                                        <div class="twm-job-st5-top">
                                            <div class="twm-media">
                                                <img src="images/home-5/jobs-company/pic4.jpg" alt="#">
                                            </div>
                                            <div class="twm-com-info">
                                                <p class="twm-job-address">New York, US</p>
                                                <a href="https://themeforest.net/user/thewebmax/portfolio" class="twm-job-com-name site-text-primary">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-st5  m-b30">
                                        <div class="twm-jobs-amount">$299 <span>/ hour</span></div>
                                        <div class="twm-job-st5-top">
                                            <div class="twm-media">
                                                <img src="images/home-5/jobs-company/pic5.jpg" alt="#">
                                            </div>
                                            <div class="twm-com-info">
                                                <p class="twm-job-address">New York, US</p>
                                                <a href="https://themeforest.net/user/thewebmax/portfolio" class="twm-job-com-name site-text-primary">
                                        ...
                                        <div class="twm-right-content">
                                            <div class="twm-candi-thum-content">
                                                <div class="twm-pics">
                                                    ...
                                                    <span><img src="images/main-slider/slider2/user/u-5.jpg" alt=""></span>
                                                    <span><img src="images/main-slider/slider2/user/u-6.jpg" alt=""></span>
                                                    <div class="tot-view"><b>500<i>+</i></b></div>
                                                </div>
                                            </div>
                                           <a href="job-detail.html" class="twm-jobs-browse site-text-primary">Apply Job</a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-st5  m-b30">
                                        ...
                                        <div class="twm-job-st5-top">
                                            <div class="twm-media">
                                                <img src="images/home-5/jobs-company/pic6.jpg" alt="#">
                                            </div>
                                            <div class="twm-com-info">
                                                <p class="twm-job-address">New York, US</p>
                                                <a href="https://themeforest.net/user/thewebmax/portfolio" class="twm-job-com-name site-text-primary">
                                        ...
                                        <div class="twm-right-content">
                                            <div class="twm-candi-thum-content">
                                                <div class="twm-pics">
                                                    ...
                                                    <span><img src="images/main-slider/slider2/user/u-5.jpg" alt=""></span>
                                                    <span><img src="images/main-slider/slider2/user/u-6.jpg" alt=""></span>
                                                    <div class="tot-view"><b>1K<i>+</i></b></div>
                                                </div>
                                            </div>
                                           <a href="job-detail.html" class="twm-jobs-browse site-text-primary">Apply Job</a>
                                        </div>
                                        ...
                                        <div class="twm-circle-jobs-wrap">
                                            ...
                                            <div class="twm-circle-jobs-box one bounce2">
                                                <div class="twm-circle-job-pics">
                                                    <img src="images/home-5/millions-jobs/company-1.png" alt="#">
                                                </div>
                                            </div>
                                            <!--2-->
                                            <div class="twm-circle-jobs-box two bounce">
                                                <div class="twm-circle-job-pics">
                                                    <img src="images/home-5/millions-jobs/company-2.png" alt="#">
                                                </div>
                                            </div>
                                            <!--3-->
                                            <div class="twm-circle-jobs-box three bounce2">
                                                <div class="twm-circle-job-pics">
                                                    <img src="images/home-5/millions-jobs/company-3.png" alt="#">
                                                </div>
                                            </div>
                                            <!--4-->
                                            <div class="twm-circle-jobs-box four bounce">
                                                <div class="twm-circle-job-pics">
                                                    <img src="images/home-5/millions-jobs/company-4.png" alt="#">
                                                </div>
                                            </div>
                                            <!--5-->
                                            <div class="twm-circle-jobs-box five bounce2">
                                                <div class="twm-circle-job-pics">
                                                    <img src="images/home-5/millions-jobs/company-5.png" alt="#">
                                                </div>
                                            </div>
                                            <!--6-->
                                            <div class="twm-circle-jobs-box six bounce">
                                                <div class="twm-circle-job-pics">
                                                    <img src="images/home-5/millions-jobs/company-6.png" alt="#">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="twm-millions-1-section-right">
                                    ...
                                    <div class="twm-read-more cplumn-2">
                                        <a href="about-1.html" class="site-button">Search Jobs</a>
                                        <a href="about-1.html" class="site-button-link underline">Learn More</a>
                                    </div>               
            ...
            <div class="section-full p-t0 p-b0 site-bg-white twm-counter-page-5-wrap">
                ...
                <div class="container">
                    <div class="twm-company-approch5-outer">
                        <div class="twm-company-approch5" style="background-image: url(images/home-5/ctr-bg.jpg);">
                            <div class="row">
            ...
            <div class="section-full p-t120 p-b90 site-bg-white">
                <div class="container">
                    ...
                    <div class="section-head center wt-small-separator-outer">
                        ...
                        <h2 class="wt-title">Discover your next 
                            career move</h2>
                    ...
                    <div class="section-content">
                        <div class="twm-recruiters5-wrap">
                                ...
                                <ul>
                                        ...
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/1.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">LinkedIn</a></h4>
                                                ...
                                                <div class="twm-job-address"><i class="feather-map-pin"></i>New York, US</div>
                                            </div>
                                        </div>
                                    </li>
                                    <!--2-->
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/2.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Apple Inc.</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/3.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Saudi Aramco</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/4.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Alphabet Inc.</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/5.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Amazon.com Inc.</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/6.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Tesla Inc.</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/7.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">NVIDIA Corp.</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/8.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Hathaway Inc.</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/9.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/10.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Meta Platforms</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/11.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Youtube</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/12.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Instagram</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/13.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">McKesson</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/14.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Foxconn</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                                    ...
                                    <li>
                                        <div class="twm-recruiters5-box">
                                            <div class="twm-rec-top">
                                                <div class="twm-rec-media">
                                                    <img src="images/home-5/recruiters/15.jpg" alt="#">
                                                </div>
                                                <div class="twm-rec-jobs">25 Jobs</div>
                                            </div>
                                            <div class="twm-rec-content">
                                                <h4 class="twm-title"><a href="job-list.html">Microsoft</a></h4>
                                                <div class="twm-rec-rating-wrap">
                                                    <div class="twm-rec-rating">
                                                        <span><i class="fa fa-star"></i></span>
                                                        <span><i class="fa fa-star"></i></span>
                            ...
                            <div class="text-center m-b30">
                                <a href="job-list.html" class=" site-button">View All</a>
                           </div>
                        </div>
                    </div>
                    ...
                    <div class="wt-separator-two-part content-white">
                        <div class="row wt-separator-two-part-row">
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-12 wt-separator-two-part-right text-right">
                                <a href="job-list.html" class=" site-button white">View All Locations</a>
                            </div>
                        </div>
                    </div>                
                    <!-- TITLE END-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="twm-featured-city2">
                                    <div class="twm-media" style="background-image:url(images/home-5/featured-cities/city1.jpg);">
                                    </div>
                                    <div class="twm-city-info">
                                        <h4 class="twm-title"><a href="job-list.html">London, England</a></h4>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="twm-featured-city2">
                                    <div class="twm-media" style="background-image:url(images/home-5/featured-cities/city2.jpg);">
                                    </div>
                                    <div class="twm-city-info">
                                        <h4 class="twm-title"><a href="job-list.html">Paris, France</a></h4>
                            ...
                            <div class="col-xl-5 col-lg-4 col-md-6">
                                <div class="twm-featured-city2">
                                    <div class="twm-media" style="background-image:url(images/home-5/featured-cities/city3.jpg);">
                                    </div>
                                    <div class="twm-city-info">
                                        <h4 class="twm-title"><a href="job-list.html">New York, USA</a></h4>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="twm-featured-city2">
                                    <div class="twm-media" style="background-image:url(images/home-5/featured-cities/city4.jpg);">
                                    </div>
                                    <div class="twm-city-info">
                                        <h4 class="twm-title"><a href="job-list.html">Bankok, Thailand</a></h4>
                            ...
                            <div class="col-xl-5 col-lg-4 col-md-6">
                                <div class="twm-featured-city2">
                                    <div class="twm-media" style="background-image:url(images/home-5/featured-cities/city5.jpg);">
                                    </div>
                                    <div class="twm-city-info">
                                        <h4 class="twm-title"><a href="job-list.html">Helsinki , Finland</a></h4>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="twm-featured-city2">
                                    <div class="twm-media" style="background-image:url(images/home-5/featured-cities/city6.jpg);">
                                    </div>
                                    <div class="twm-city-info">
                                        <h4 class="twm-title"><a href="job-list.html">Berlin, Germany</a></h4>
            ...
            <div class="section-full p-t60 site-bg-white twm-new-sub-section-wrap site-bg-cover" style="background-image: url(images/dotted-map.png);">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="twm-sub-2-section site-bg-cover" style="background-image: url(images/nwl-bg.png);">
                                    ...
                                    <div class="twm-sub-discription">Get the latest updates mailed to you</div> 
                                    <form>
                                        <div class="form-group">
                                            <input name="news-letter" class="form-control" placeholder="Enter Your Email Address" type="text">
                                        </div>
                                        <button class="site-button twm-sub-btn white">Subscribe Now</button>
                                    </form> 
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-12">
...
<!-- Mirrored from thewebmax.org/jobzilla/index-5.html?theme=css/skin/skin-1 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:25:44 GMT -->
</html>
