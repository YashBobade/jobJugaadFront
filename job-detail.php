...
<head>
    ...
    <style>
  /* General input styling with class yash */
/* General input styling with class yash */
.yash input[type="file"] {
    appearance: none; /* Remove default file input styling */
    background-color: #f0f6fe; /* Set the background color to #f0f6fe */
    ...
    position: relative; /* Necessary for positioning icon */
    text-overflow: ellipsis; /* Add ellipsis for overflow text */
}

/* Hide the default "Choose File" text */
.yash input[type="file"]::-webkit-file-upload-button {
    visibility: hidden; /* Hide the default button and text */
}

/* Add custom placeholder text */
.yash input[type="file"]:before {
    content: 'Choose a file'; /* Placeholder text */
...
/* Hover and focus styles for the file input with class yash */
.yash input[type="file"]:hover {
    background-color: #e1e9f1; /* Lighter background on hover */
}


/* Icon placement for class yash */
.yash i {
    position: absolute;
    right: 15px; /* Position icon to the right */
    top: 50%; /* Center icon vertically */
    transform: translateY(-50%);
    color: #6c757d; /* Match input text color */
}
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <div class="cabdidate-de-info">
                                        ...
                                        <div class="twm-job-self-info">
                                            <div class="twm-job-self-top">
                                                ...
                                                <div class="twm-mid-content">
                                                    ...
                                                    <p class="twm-job-address"><i class="fas fa-briefcase"></i> 0 to 5 years</p>

                                                    <p class="twm-job-address"><i class="fas fa-map-marker-alt"></i> Nagpur Maharashtra India</p>

                                                    
                                                    <div class="twm-job-self-mid">
                                                        <div class="twm-job-self-mid-left">
                                                            <div class="twm-jobs-amount">&#8377;20000 - &#8377;25000</div>
                                                        </div>
                                    ...
                                    <ul class="description-list-2" style="text-align: justify;">
                                        <li>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="job-detaila39b.html?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="job-detail61e7.html?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="job-detailcce5.html?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="job-detail13f7.html?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="job-detail19a6.html?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="job-detailfe5c.html?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="job-detailab47.html?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="job-detail5f8d.html?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="job-detail5663.html?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="job-detail28ac.html?theme=css/skin/skin-10"></a></li>
...
<!-- STYLE SWITCHER END ==== -->
 <script>
// JavaScript to handle the file selection and display the file name
document.querySelector('.yash input[type="file"]').addEventListener('change', function() {
    var fileInput = this;
    var fileName = fileInput.files.length > 0 ? fileInput.files[0].name : 'No file chosen';
    
    // Create or update the file name display
    var fileNameDisplay = fileInput.nextElementSibling;
    if (!fileNameDisplay) {
...
<!-- Mirrored from thewebmax.org/jobzilla/job-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:23:16 GMT -->
</html>
