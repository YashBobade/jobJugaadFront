...
<!-- Mirrored from thewebmax.org/jobzilla/index-18.html?theme=css/skin/skin-2 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:25:53 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Jobzilla Template | Home Page Style 18</title>
    ...
    <link rel="stylesheet" class="skin" type="text/css" href="css/skins-type/skin-10.css">
...
<body data-anm=".anm">
	...
	<div class="page-wraper">
        ...
        <!-- HEADER START -->
        <header  class="site-header header-style-3 h-page-18-hdr mobile-sider-drawer-menu">
                    ...
                    <div class="container-fluid clearfix"> 
                        ...
                        <div class="logo-header">
                            <div class="logo-header-inner logo-header-one">
                                <a href="index.html">
                                <img src="images/skins-logo/logo-skin-10.png" alt="">
                                </a>
                            </div>
                        </div>  
        ...
        <div class="page-content">
            ...
            <div class="twm-home18-banner-section">
                ...
                <div class="row"  style="background-image: url(images/home-18/banner/dot-map.png);">
                    <!--Left Section-->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="twm-h-page-18-bnr-right-section">
                            <div class="twm-h-page18-bnr-pic">
                                <img src="images/home-18/banner/bnr-pic.png" alt="#">
                            </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="v-noti-wrap">
                                                <div class="v-media">
                                                    <i class="far fa-check-circle twm-bg-purple"></i>
                                                </div>
                                                <div class="v-content">
                                                    <h4 class="wt-title">Congratulations</h4>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="v-noti-wrap">
                                                <div class="v-media">
                                                    <i class="far fa-envelope twm-bg-green"></i>
                                                </div>
                                                <div class="v-content">
                                                    <h4 class="wt-title">Congrats</h4>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="widget widget_about">
                                <div class="logo-footer clearfix">
                                    <a href="index.html"><img src="images/skins-logo/mainten-logo-10.png" alt=""></a>
                                </div>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="index-18a39b.html?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="index-1861e7.html?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="index-18cce5.html?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="index-1813f7.html?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="index-1819a6.html?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="index-18fe5c.html?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="index-18ab47.html?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="index-185f8d.html?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="index-185663.html?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="index-1828ac.html?theme=css/skin/skin-10"></a></li>
        </ul>           
...
<!-- Mirrored from thewebmax.org/jobzilla/index-18.html?theme=css/skin/skin-2 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:25:54 GMT -->
</html>
