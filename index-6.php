...
<!-- Mirrored from thewebmax.org/jobzilla/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:21:59 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Jobzilla Template | Home Page Style 6</title>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="twm-bnr-left-section">
                                <div class="twm-bnr-title-small">
                                    ...
                                    <span class="site-text-primary">Jobzilla</span>
                                </div>
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="h-page-6-getjobs-right">
                                    ...
                                    <div class="section-head left wt-small-separator-outer">
                                        ...
                                        <h2 class="wt-title">Get World <span class="site-text-primary">1500+</span> 
                                            Talented People in 
                                            one place
                                        </h2>
                ...
                <div class="twm-hpage-6-featured-area">
                    ...
                    <div class="container">
                        ...
                        <div class="twm-hpage-6-featured-content-warp m-b30">
                            ...
                            <div class="text-center job-categories-btn">
                                <a href="job-list.html" class=" site-button">Show All Jobs</a>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="counter-outer-two">
                                            ...
                                            <div class="icon-content">
                                                <div class="tw-count-number site-text-white">
                                                    <span class="counter text-clr-pink">1740</span></div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="counter-outer-two">
                                            ...
                                            <div class="icon-content">
                                                <div class="tw-count-number site-text-white">
                                                    <span class="counter text-clr-purple">16</span></div>
                                ...
                                <div class="col-xl-5 col-lg-12 col-md-12">
                                    <div class="twm-explore-content-outer2">
                                        <div class="twm-explore-top-section">
                                            ...
                                            <!-- TITLE END-->
                                            <div class="twm-read-more">
                                                <a href="about-1.html" class="site-button">Show All Quotes</a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="testimonials-v">
                                                        ...
                                                        <div class="testimonial-v-content">
                                                            ...
                                                            <div class="t-discription">I have minim mollit non deserunt ullamco est sit aliqua 
                        ...
                        <div class="row wt-separator-two-part-row">
                            <div class="col-xl-6 col-lg-6 col-md-12 wt-separator-two-part-left">
                                ...
                                <div class="section-head left wt-small-separator-outer">
                                    ...
                                    <h2 class="wt-title">Our Regular Updated Blog Posts</h2>
                                </div>                  
                                <!-- TITLE END-->
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 wt-separator-two-part-right text-right">
                                <a href="job-list.html" class=" site-button">Explore All Blogs</a>
                            </div>
                        </div>
                    </div>
                       ...
                       <div class="twm-jobs-grid-wrap">
                           <div class="row masonry-wrap">
                                <div class="masonry-item col-lg-4 col-md-6 m-b30">
                                    ...
                                    <div class="blog-post twm-blog-post-h-page6">
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="images/home-6/blog/latest/bg1.jpg" alt=""></a>
                                        </div>                                    
                                        <div class="wt-post-info">
                                            <div class="wt-post-meta ">
                                                <ul>
                                                    <li class="post-date">12-02-2023</li>
                                                </ul>
                                            </div>
                                            <div class="wt-post-title ">
                                                <h4 class="post-title">
                                                    <a href="blog-single.html">5 things to know about the May 2023 jobs report</a>
                                                </h4>
                                            </div>
                                ...
                                <div class="masonry-item col-lg-8 col-md-6 m-b30">
                                    ...
                                    <div class="blog-post with-content twm-blog-post-h-page6">
                                        ...
                                        <div class="wt-post-info">
                                            <div class="wt-post-meta ">
                                                <ul>
                                                    <li class="post-date">16-02-2023</li>
                                                </ul>
                                            </div>
                                            <div class="wt-post-title ">
                                                <h4 class="post-title">
                                            ...
                                            <div class="post-author">
                                                <div class="post-author-pic">
                                                    <div class="p-a-pic"><img src="images/home-6/blog-avtar/pic1.jpg" alt=""></div>
                                                    <div class="p-a-info">
                                        ...
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="images/home-6/blog/latest/bg2.jpg" alt=""></a>
                                        </div> 
                                ...
                                <div class="masonry-item col-lg-4 col-md-6 m-b30">
                                   ...
                                   <div class="blog-post twm-blog-post-h-page6">
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="images/home-6/blog/latest/bg3.jpg" alt=""></a>
                                        </div>                                    
                                        <div class="wt-post-info">
                                            <div class="wt-post-meta ">
                                                <ul>
                                            ...
                                            <div class="wt-post-title ">
                                                <h4 class="post-title">
                                                    <a href="blog-single.html">JobBoard is the most important
                                ...
                                <div class="masonry-item col-lg-4 col-md-6 m-b30">
                                    ...
                                    <div class="blog-post twm-blog-post-h-page6">
                                         <div class="wt-post-media">
                                             <a href="blog-single.html"><img src="images/home-6/blog/latest/bg4.jpg" alt=""></a>
                                         </div>                                    
                                         <div class="wt-post-info">
                                             <div class="wt-post-meta ">
                                                 <ul>
                                                     <li class="post-date">18-02-2023</li>
                                                 </ul>
                                             </div>
                                             <div class="wt-post-title ">
                                                 <h4 class="post-title">
                                                     <a href="blog-single.html">After-School educator and recess coach</a>
                                                 </h4>
                                             </div>
                                         </div>                                
                                     </div> 
                                 ...
                                 <div class="masonry-item col-lg-4 col-md-6 m-b30">
                                    ...
                                    <div class="blog-post twm-blog-post-h-page6">
                                         <div class="wt-post-media">
                                             <a href="blog-single.html"><img src="images/home-6/blog/latest/bg5.jpg" alt=""></a>
                                         </div>                                    
                                         <div class="wt-post-info">
                                             <div class="wt-post-meta ">
                                                 <ul>
                                                     <li class="post-date">22-02-2023</li>
                                                 </ul>
                                             </div>
                                             <div class="wt-post-title ">
                                                 <h4 class="post-title">
                                                     <a href="blog-single.html">Job That Has Never Been Revealed For The. </a>
                                                 </h4>
                                             </div>
                                         </div>                                
                                     </div> 
                            ...
                            <div class="col-lg-7 col-md-12">
                                <div class="twm-hpage-6-getintouch">
                                    ...
                                    <div class="twm-hpage-6-getintouch-title">
                                        <div class="wt-title-small">Latest Blog</div>
                                        <h2 class="wt-title">
                                    ...
                                    <div class="twm-hpage-6-callus">
                                        ...
                                        <div class="callus-content">
                                            <div class="callus-number">555-281-5426</div> 
                                            <div class="callus-email">Info@jobzilla.com</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="index-6a39b.html?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="index-661e7.html?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="index-6cce5.html?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="index-613f7.html?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="index-619a6.html?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="index-6fe5c.html?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="index-6ab47.html?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="index-65f8d.html?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="index-65663.html?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="index-628ac.html?theme=css/skin/skin-10"></a></li>
...
<!-- Mirrored from thewebmax.org/jobzilla/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:22:08 GMT -->
</html>
