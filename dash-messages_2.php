...
<!-- Mirrored from thewebmax.org/jobzilla/dash-messages_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:26:33 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Jobzilla Template | dashboard messages</title>
            ...
            <div class="content-admin-main">
				...
				<div class="panel panel-default">
                    <div class="panel-heading wt-panel-heading p-a20">
                        <h4 class="panel-tittle m-a0"><i class="far fa-envelope"></i>Inbox</h4>
                    </div>
                    <div class="panel-body wt-panel-body bg-white">
                       		...
                       		<div class="dashboard-messages-box">
                                ...
                                <div class="dashboard-message-area">
                                    ...
                                    <div class="dropdown">
                                        <a href="javascript:;" class="dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                          Reply
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                         
                                          <div class="dashboard-message-reply-textarea p-a20">
                                                        
                                            <div class="form-group wt-input-icon">
                                                <div class="input-group">
                                                    <i class="input-group-addon fa fa-pencil v-align-t "></i>
                                                    <textarea aria-required="true" rows="4" cols="45" name="comment"  class="form-control" placeholder="Message *"></textarea>
                                                </div>
                                            </div>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="dash-messages_2a39b.html?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="dash-messages_261e7.html?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="dash-messages_2cce5.html?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="dash-messages_213f7.html?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="dash-messages_219a6.html?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="dash-messages_2fe5c.html?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="dash-messages_2ab47.html?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="dash-messages_25f8d.html?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="dash-messages_25663.html?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="dash-messages_228ac.html?theme=css/skin/skin-10"></a></li>
...
<!-- Mirrored from thewebmax.org/jobzilla/dash-messages_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2024 05:26:35 GMT -->
</html>
