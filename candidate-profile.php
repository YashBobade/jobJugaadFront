                            ...
                            <div class="side-bar-st-1">
                                ...
                                <div class="twm-nav-list-1">
                                    <ul>
                                        ...
                                        <li><a href="candidate-my-resume.php"><i class="fa fa-receipt"></i> View Resume</a></li>
                                        <li><a href="candidate-my-resume.php"><i class="fa fa-video"></i> View Introduction</a></li>
